...
const nuevaString = "Este debe ser un string";
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  var ValorEuro = 1.20;
  var equivale = euro * ValorEuro;
  return 'el valor del euron en dolares de ' + euro + 'equivale a : ' +  ValorEuro;
...
function esVocal(letra){
  ...
  if(letra > 1 ){
    ...
    return 'el valor' + letra + 'es una vocal';
  }
}
